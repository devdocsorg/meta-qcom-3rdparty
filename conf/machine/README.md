<!-- Generated from conf/machine/ at wrynose @ e804c5eb (2026-09-08) by docsgen on 2026-09-08. Manual edits will be overwritten on regeneration; change the source, not this page. -->

# conf/machine/

Machine configurations for the two boards this layer supports, [`uno-q`](uno-q.md) and [`radxa-dragon-q6a`](radxa-dragon-q6a.md). A build selects one by setting `MACHINE` to the file's basename. Used by [.github/workflows/build-yocto.yml](../../.github/workflows/build-yocto.yml), [ci/radxa-dragon-q6a.yml](../../ci/radxa-dragon-q6a.yml), [ci/uno-q.yml](../../ci/uno-q.yml) and meta-qcom's compile action.
