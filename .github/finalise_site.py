...
# Qualcomm's repolinter rules require a licence header in every JavaScript file;
# the search index derives from this repository's MIT-licensed documentation.
index = site / "searchindex.js"
header = ("/* Search index generated by Sphinx from the meta-qcom-3rdparty documentation.\n"
          "   Copyright (c) meta-qcom-3rdparty contributors. SPDX-License-Identifier: MIT */\n")
original = index.read_text()
if not original.startswith(header):
    index.write_text(header + original)
