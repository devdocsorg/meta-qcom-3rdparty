<!-- Generated from recipes-kernel/linux/linux-arduino_7.0.bb at wrynose @ e804c5eb (2026-09-08) by docsgen on 2026-09-08. Manual edits will be overwritten on regeneration; change the source, not this page. -->
...
| [`SECTION`](https://docs.yoctoproject.org/ref-manual/variables.html#term-SECTION) `=` | Package category recorded in the metadata of the produced packages. This file sets it to `kernel`. |
...
| [`LINUX_VERSION`](https://docs.yoctoproject.org/ref-manual/variables.html#term-LINUX_VERSION) `?=` | Kernel version reported by the kernel build. This file sets it to `7.0`. |
| [`PV`](https://docs.yoctoproject.org/ref-manual/variables.html#term-PV) `=` | Package version. Left unset, the version is taken from the recipe filename. This file sets it to `${LINUX_VERSION}`. |
| [`SRCREV`](https://docs.yoctoproject.org/ref-manual/variables.html#term-SRCREV) `?=` | Source revision fetched for the SCM entry in `SRC_URI`. This file sets it to `122c2c22d838ca826e7f4e7360df96fb4e8f7ad2`. |
...
| [`S`](https://docs.yoctoproject.org/ref-manual/variables.html#term-S) `=` | Directory holding the unpacked sources that the recipe's tasks build in. |
| [`KBUILD_DEFCONFIG`](https://docs.yoctoproject.org/ref-manual/variables.html#term-KBUILD_DEFCONFIG) `?=` | Names the in-tree kernel defconfig used as the base configuration before fragments are merged. This file sets it to `defconfig`. |
