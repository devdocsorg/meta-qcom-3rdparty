...
Third-Party Maintained Qualcomm based platforms. It depends on [meta-qcom](https://github.com/qualcomm-linux/meta-qcom)
...
Machines available at [conf/machine](https://github.com/devdocsorg/meta-qcom-3rdparty/tree/docs/layer-documentation/conf/machine), kas fragments at `ci/<machine>.yml`.
...
Follow the [contribution guide](CONTRIBUTING.md#27--branches-and-pull-requests)
for the target branch and the pull request flow.

Important constraints from the [contribution guide](CONTRIBUTING.md):

- **No recipe forks:** do not copy recipes from [meta-qcom](https://github.com/qualcomm-linux/meta-qcom), [meta-qcom-hwe](https://github.com/qualcomm-linux/meta-qcom-hwe), or
  base OE / Yocto layers. Use `.bbappend` files instead.
- **Machine-specific isolation:** use machine overrides (`:machine` / `:append:machine`)
  to confine board-specific logic. SoC-generic behavior must go upstream to [meta-qcom](https://github.com/qualcomm-linux/meta-qcom).
...
Follow Yocto submission guidance referenced in the contribution guide:
