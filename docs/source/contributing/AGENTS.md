...
Follow the repository [README.md](https://github.com/qualcomm-linux/meta-qcom-3rdparty/blob/main/README.md)
and [CONTRIBUTING.md](CONTRIBUTING.md) contribution flow:
