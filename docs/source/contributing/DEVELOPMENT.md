...
The [nearby map at the bottom of the root README](https://github.com/devdocsorg/meta-qcom-3rdparty/blob/test/qualcomm-upgrade-astra/README.md#repository-map)
