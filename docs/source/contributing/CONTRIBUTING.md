...
Start with the [development environment walkthrough](DEVELOPMENT.md) for checkout,
container and documentation tools, and checks.
...
File: [conf/machine/rubikpi3.conf](../../../conf/machine/rubikpi3.conf)
...
File: [recipes-bsp/packagegroups/packagegroup-rubikpi3.bb](../../../recipes-bsp/packagegroups/packagegroup-rubikpi3.bb)
...
File: [recipes-bsp/firmware-boot/firmware-qcom-boot-rubikpi3_20260621.bb](../../../recipes-bsp/firmware-boot/firmware-qcom-boot-rubikpi3_20260621.bb)
...
File: [ci/rubikpi3.yml](../../../ci/rubikpi3.yml)
