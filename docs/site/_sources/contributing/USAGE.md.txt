...
If you already have a compatible Yocto environment, clone the layer beside its
build directory:
...
Then run this command from the initialized build directory, with the required
`core` and `qcom` layers already present:
