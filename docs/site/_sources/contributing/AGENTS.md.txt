...
Machines available at [conf/machine](https://github.com/qualcomm-linux/meta-qcom-3rdparty/tree/main/conf/machine), kas fragments at `ci/<machine>.yml`.
...
Follow the repository [README.md](https://github.com/qualcomm-linux/meta-qcom-3rdparty/blob/main/README.md) and [contribution guidelines](CONTRIBUTING.md) contribution flow:
...
Important constraints from [contribution guidelines](CONTRIBUTING.md):
