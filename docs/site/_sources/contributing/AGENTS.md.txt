...
Machines available at [`conf/machine`](https://github.com/devdocsorg/meta-qcom-3rdparty/blob/docs/offline-layer-guides/conf/machine/README.md), kas fragments at `ci/<machine>.yml`.
...
Follow the repository [README.md](https://github.com/devdocsorg/meta-qcom-3rdparty/blob/docs/offline-layer-guides/README.md) and [CONTRIBUTING.md](CONTRIBUTING.md) contribution flow:
...
Important constraints from [CONTRIBUTING.md](CONTRIBUTING.md):
