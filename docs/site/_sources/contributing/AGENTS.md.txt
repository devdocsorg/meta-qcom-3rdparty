...
Machines available at [conf/machine](https://github.com/devdocsorg/meta-qcom-3rdparty/tree/docs/contributor-reference/conf/machine), kas fragments at `ci/<machine>.yml`.
...
Follow the repository [README](https://github.com/devdocsorg/meta-qcom-3rdparty/blob/docs/contributor-reference/README.md) and [contribution guide](CONTRIBUTING.md) contribution flow:
...
Important constraints from [contribution guide](CONTRIBUTING.md):
