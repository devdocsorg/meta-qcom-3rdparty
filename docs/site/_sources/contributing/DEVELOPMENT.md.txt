...
The [nearby map at the bottom of the root README](https://github.com/devdocsorg/meta-qcom-3rdparty/blob/docs/repository-documentation/README.md#repository-map)
...
The [canonical repository documentation specification](https://github.com/devdocsorg/qli2-example-repo/blob/main/SPECIFICATION.md)
defines the documentation requirements; maintain the requirements there.
